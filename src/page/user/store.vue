...
export default {
    ...
    methods:{
        ...
        // 获取菜单数据
        getClasslist(){
            this.$http.get('/ele/shopping/v2/menu?restaurant_id='+this.storeId)
            .then((data)=>{
...
/* 引导边框 */
.merch .left,.class-main,.mer-main,.price,.num{
...
.store-main p,.store-main feSpecularLighting{
    font-size: 3vw;
    color: #999;
    margin: 1vw 0.5vw;
}
.msg-ati,.msg-top,.msg-foot{
    background-color: white;
    padding: 3vw 2vw;
    border-bottom: 1px solid #dddddd;
    margin-bottom: 2vw;
